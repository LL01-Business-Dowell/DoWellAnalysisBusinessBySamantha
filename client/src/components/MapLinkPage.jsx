    ...
    <div className='relative flex flex-col justify-between h-full min-h-[640px] p-3'>
      ...
      <div className='flex flex-col p-5 pl-25'>
        ...
        <div className='flex items-center mb-2 relative'>
          ...
          />
          <button
            onClick={() => window.open('https://youtube.com/shorts/esuXEo8rulA?si=RT97O3t6An54ZLwV', '_blank')}
            className='ml-2 p-2 text-blue-500 hover:text-blue-700'
            aria-label='Watch Info Video'
          >
            <Info size={20} />
          </button>
          {showTooltip && (
            <div className='absolute top-10 right-0 bg-gray-700 text-white text-xs rounded-lg px-2 py-1 shadow-md animate-fade-in'>
              Click for help
            </div>
          )}
        </div>
